...
from functions.os_ops import open_calculator, open_camera, open_cmd, open_notepad, open_discord, shutdown, close_notepad, close_discord, close_cmd
from random import choice
from utils import opening_text
from pprint import pprint


USERNAME = 'Aman'#config('USER')
BOTNAME = 'Aria'#config('BOTNAME')
